  ...
  const applyPrecisionLipstick = async () => {
    ...
    try {
      ...
      if (makeupResult.success) {
        ...
        toast({
          title: "✅ تم التطبيق المحترف بنجاح",
          description: "تقنية ModiFace طبقت أحمر الشفاه داخل الحدود تماماً",
        });
      } else {
